...
latex_documents = [
    (master_doc, "couleur.tex", u"couleur Documentation", u"Gabriel Falcão", "manual")
]
...
man_pages = [(master_doc, "couleur", u"couleur Documentation", [author], 1)]
