...
def test_output_bold_green_on_bold_white_alternative():
...
def test_ignoring_colors_alternative():
...
def test_supress_up_when_ignoring_colors_alternative():
...
def test_supress_up_when_ignoring_colors_as_many_times_needed_alternative():
